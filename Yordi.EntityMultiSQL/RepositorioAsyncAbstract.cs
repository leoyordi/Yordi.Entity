...
namespace Yordi.EntityMultiSQL
{
    public abstract class RepositorioAsyncAbstract<T> : RepositorioBaseAbstract<T> where T : class
    {
        ...
        public virtual async Task<T?> Incluir(T obj)
        {
            ...
            if (result == null)
                Message("Objeto n�o foi inclu�do!");
            return result;
        }
        ...
        /// <summary>
        /// Atualiza ou inclui o objeto, dependendo se ele j� existe ou n�o. <br/>
        /// Usa a mesma transa��o de banco para SELECT, INSERT e UPDATE. Caso n�o tenha sucesso, usa Rollback.<br/>
        ...
        protected async Task<bool> UpdateTransaction(DbConnection conexaoSql, List<ColumnTable> colunas)
        {
            ...
            {
                Error("Imposs�vel atualizar, n�o h� colunas de refer�ncia para a cl�usula WHERE");
                return false;
            }
        ...
        public virtual async Task<bool> Excluir(T obj)
        {
            ...
            if (item != null)
            {
                ...
                Message($"{_tableName} exclu�dos: {result}");
                return result > 0;
            }
            else
            {
                Message($"Nenhum {_tableName} encontrado. Nada foi exclu�do!");
                return false;
            }
        }

        /// <summary>
        /// Exclui os objetos informados com base na lista de par�metros em <paramref name="where"/>
        /// </summary>
        ...
        /// <summary>
        /// Traz a lista inteira de elementos da tabela do objeto T e aplica a fun��o <paramref name="where"/>
        /// </summary>
        /// <param name="where"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retorna uma lista de objetos de acordo com as informa��es passadas
        /// </summary>
        /// <param name="keys">Lista de chaves para montar a cl�usula WHERE</param>
        /// <param name="ou">Informar na clausula WHERE se usa OR ou AND (padr�o � AND)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Usa a cl�usula WHERE com IN caso o array seja menor que 100.
        /// Caso contr�rio, usa JOIN com tabela criada para isso (Temp_In_Use), onde os ids ser�o inseridos nela.
        /// <b>Por enquanto s� funciona com classes que implementaram a interface IAuto</b>
        /// </summary>
        ...
        public virtual async Task<IEnumerable<T>?> Lista(int[] ids)
        {
            ...
            try
            {
                using (DbConnection conexaoSql = await _bd.ObterConexaoAsync())
                {
                    ...
                    {
                        Message("Sem conex�o com banco ou arquivo de dados");
                        return default;
                    }
                    using (DbCommand cmm = conexaoSql.CreateCommand())
                    {
        ...
        /// <summary>
        /// Usa a cl�usula WHERE com IN caso o array seja menor que 100.<br/>
        /// Caso contr�rio, usa JOIN com tabela criada para isso (Temp_In_Use), onde os ids ser�o inseridos nela.<br/>
        /// <b>O campo de busca ser� o informado no par�metro <paramref name="campoUnico"/></b>
        /// </summary>
        /// <param name="ids"></param>
        /// <param name="campoUnico">Campo a ser usado do lado esquerdo da opera��o.<br/>
        ...
        public virtual async Task<IEnumerable<T>?> Lista(int[] ids, string campoUnico)
        {
            ...
            {
                Message($"N�o tem o campo {campoUnico}");
                return null;
            }
        ...
        /// <summary>
        /// Retorna uma lista de objetos de acordo com a instru��o SQL passada
        /// </summary>
        /// <param name="sql"></param>
        /// <param name="parametros">Se quiser usar DbParameters ou quiser que a cl�usula where seja preenchida por essa lista</param>
        /// <param name="ou"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Construtor de instru��o SQL SELECT. A cl�usula WHERE � preenchida de acordo com o objeto IEnumerable<Chave>
        /// </summary>
        /// <param name="campos">Objeto IEnumerable<Chave>. Quando for STRING, a cl�usula WHERE ter� o termo LIKE</param>
        /// <returns></returns>
        ...
        private void ConstraintExceptionError(DataTable? dt, ConstraintException ce)
        {
            if (dt == null)
            {
                ...
                ce.Data.Add("DataTable", "N�o foi poss�vel rastrear erros. DataTable � nulo aqui.");
                Error(ce);
                return;
            }
        ...
        /// </summary>
        /// <param name="where">Lista de Objeto Chave, que ser� usado na cl�usula WHERE com par�metros</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Procura o objeto pelo c�digo de autoincremento
        /// </summary>
        ...
        /// </summary>
        /// <param name="obj"></param>
        /// <returns>Objeto com o novo c�digo de autoincremento</returns>
        ...
        /// <summary>
        /// Atualiza objeto original com dados de salvamento, como datas de inser��o e atualiza��o,
        /// usu�rios de inser��o e atualiza��o, origem do comando, e valor de autoincremento.<br/>
        /// Tento retornar com o objeto original atualizado, pois pode ter propriedades que n�o s�o salvas em banco
        ...
        /// <summary>
        /// Incluir lista de objetos com a mesma conex�o de banco
        /// </summary>
        ...
        /// <summary>
        /// Atualiza uma lista de objetos com base em atributos de chave prim�ria ou autoincremento.
        /// </summary>
        /// <param name="lista"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Somente em MySQL e SQLite. Usa a cl�usula ON DUPLICATE KEY UPDATE
        /// </summary>
        /// <param name="lista"></param>
        ...
        public virtual async Task<IEnumerable<T>?> AtualizarOuIncluir(IEnumerable<T> lista, bool dispararEventoProgresso = false)
        {
            ...
            {
                Message("MySQL, SQLite, Postgrees aceita a a��o Update On Duplicate Key");
                return null;
            }
            else if (lista == null)
            {
            ...
            return await ExecuteFullWriteAsync(async () =>
            {
                ...
                try
                {
                    ...
                    else if (keys != null && keys.Any())
                    {
                        ...
                        throw new ArgumentException("N�o � poss�vel fazer Update On Duplicate Key sem Key", typeof(T).Name);
        ...
        /// <summary>
        /// Insere ou atualiza o objeto. Testado em MySQL e SQLite. Usa a instru��o ON DUPLICATE KEY UPDATE.
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        public virtual async Task<T?> Upsert(T obj)
        {
            ...
            return await ExecuteFullWriteAsync(async () =>
            {
                ...
                {
                    if (Verbose)
                        Message($"Inclu�do/Alterado [Retorno: {resultado}]: {obj}");
                }
            });
        }
        ...
        private async Task<int> Delete(T obj)
        {
            ...
            if (Verbose && resultado > 0)
                Message($"Exclu�do: {obj} - {resultado} linha(s) afetada(s)");
            Rows(resultado);
            return resultado;
        }
        ...
        private async Task<int> Delete(IEnumerable<T> lista, bool dispararEventoProgresso = false)
        {
            ...
            var resultado = await ExecuteFullWriteAsync(async () =>
            {
                ...
                if (Verbose)
                    Message($"Exclu�dos: {lista.Count()} - {rowAffected} linha(s) afetada(s) em {_tableName}");
                return rowAffected;
            });
        ...
        /// <summary>
        /// Para instru��es UPDATE, INSERT e DELETE, o valor de retorno � o n�mero de linhas afetadas pelo comando. 
        /// Para todos os outros tipos de declara��es, o valor retornado � -1.
        /// </summary>
        ...
        private async Task<int> Delete(IEnumerable<Chave> camposParaWhere)
        {
            ...
            {
                Message("Imposs�vel excluir, faltam dados.");
                return -1;
            }
            ...
            if (Verbose)
                Message($"Exclu�dos: {camposParaWhere.Count()} - {resultado} linha(s) afetada(s) em {_tableName}");
            Rows(resultado);
            Message($"Exclu�dos: {resultado}");
            return resultado;
        }
        ...
        /// <summary>
        /// Executa uma opera��o de escrita no SQLite com lock exclusivo e retry autom�tico.
        /// Para MySQL e outros bancos, executa diretamente sem lock.
        /// </summary>
        /// <param name="writeOperation">Opera��o de escrita a ser executada</param>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                Message($"Opera��o de escrita cancelada em {_tableName}");
                return 0;
            }
            catch (Exception e)
            {
        ...
        /// <summary>
        /// Sobrecarga para par�metros do tipo Chave
        /// </summary>
        private async Task<int> ExecuteWriteAsync(
            Func<Task<int>> writeOperation,
            string sql,
        ...
        /// <summary>
        /// Executa uma opera��o completa de escrita (conex�o + transa��o + execu��o)
        /// dentro do lock exclusivo do SQLite.
        /// </summary>
        /// <typeparam name="TResult">Tipo do resultado</typeparam>
        /// <param name="writeOperation">Opera��o completa incluindo conex�o</param>
        /// <param name="cancellationToken">Token de cancelamento</param>
        ...
        /// <summary>
        /// Tenta liberar locks e repetir opera��o (controle de recurs�o)
        /// </summary>
        ...
        ///// <summary>
        ///// Executa opera��o com retry autom�tico para SQLite em caso de database locked
        ///// </summary>
        ...
        //    // Limpa pools e for�a GC
        //    SQLiteRetryHelper.LimparPoolsConexao();

        //    // Tenta liberar via conex�o
        //    await _bd.LiberarLocksSQLiteAsync();
